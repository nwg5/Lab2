public class lab2 {
	...
	if (manGoingToStIves) {
	    ...
	    total = (double) 2 + (numWives) + (numWives * numSacksPerWife) + (numWives * numSacksPerWife * numCatsPerSack) + (numWives * numSacksPerWife * numCatsPerSack * numKitsPerCat);
	} else {
